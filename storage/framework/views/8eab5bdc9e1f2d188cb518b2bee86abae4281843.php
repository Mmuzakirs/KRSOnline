...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <!-- Plugin JavaScript -->
    <script src="<?php echo e(asset('agency/vendor/jquery-easing/jquery.easing.min.js')); ?>"></script>

    <!-- Contact form JavaScript -->
    <script src="<?php echo e(asset('agency/js/jqBootstrapValidation.js')); ?>"></script>
    <script src="<?php echo e(asset('agency/js/contact_me.js')); ?>"></script>
